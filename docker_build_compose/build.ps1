...
Invoke-Expression -Command ("docker build --build-arg PYTHON_VERSION=" + $PYTHON_VERSION + " --build-arg NB_USERs="+ $NB_USERs + " -f jupyterhub-base.Dockerfile -t jupyterhub-base .")
